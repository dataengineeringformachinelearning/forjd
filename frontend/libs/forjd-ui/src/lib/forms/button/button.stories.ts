...
export const Disabled: Story = {
  ...
  render: (args) => ({
    props: args,
    template: `
      <forjd-button [variant]="variant" [disabled]="disabled">Disabled</forjd-button>
    `,
  }),
};
...
export const SquareIcon: Story = {
  ...
  args: { variant: 'ghost', square: true, ariaLabel: 'Open search' },
  render: (args) => ({
    props: args,
    template: `
      <forjd-button
  ...
  render: () => ({
    ...
    template: `
      <div style="display:flex;flex-wrap:wrap;gap:var(--suite-space-2)">
        <forjd-button variant="primary">Primary</forjd-button>
        <forjd-button variant="secondary">Secondary</forjd-button>
        <forjd-button variant="outline">Outline</forjd-button>
        <forjd-button variant="ghost">Ghost</forjd-button>
        <forjd-button variant="danger">Danger</forjd-button>
        <forjd-button variant="primary" [disabled]="true">Disabled</forjd-button>
      </div>
    `,
  }),
};
